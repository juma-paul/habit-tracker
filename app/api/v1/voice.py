...
SUPPORTED_TYPES = {"audio/webm", "audio/mp3", "audio/mpeg", 
        "audio/wav", "audio/m4a", "audio/mp4", "audio/ogg"}
...
async def voice_chat(
    ...
    if base_type not in SUPPORTED_TYPES:
        raise HTTPException(400, f"Unsupported format. Use: {', '.join(SUPPORTED_TYPES)}")
    ...
    # Transcribe
    transcript = await transcribe(data, audio.content_type)
