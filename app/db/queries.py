...
async def create_log(habit_id: int, user_id: int, value: float, notes: str | None = None) -> dict:
...
async def update_conversation(conversation_id: int, user_id: int, **fields) -> dict | None:
...
async def get_messages(conversation_id: int, user_id: int, limit: int = 100) -> list[dict]:
...
async def get_recent_messages(conversation_id: int, user_id: int, limit: int = 10) -> list[dict]:
